...
#define cpu_map_h
  ...
  #if N_AXIS > 3
    #define DIRECTION_PORT_3 B // Axis number 6 (Ramps Aux-3 D51)
  #endif
  #if N_AXIS > 4
    #define DIRECTION_PORT_4 C // Axis number 5 (Ramps E1)
  #endif
  #if N_AXIS > 5
    #define DIRECTION_PORT_5 A // Axis number 4 (Ramps E0)
  #endif
  ...
  #if N_AXIS > 3
    #define STEPPER_DISABLE_PORT_3 B // Axis number 4 (Ramps Aux-3 D53)
  #endif
  #if N_AXIS > 4
    #define STEPPER_DISABLE_PORT_4 C // Axis number 5 (Ramps E1)
  #endif
  #if N_AXIS > 5
    #define STEPPER_DISABLE_PORT_5 A // Axis number 5 (Ramps E0)
  #endif
  ...
  #if N_AXIS > 3
    #define STEPPER_DISABLE_BIT_3 0 // Axis number 4 Step - Pin D53
  #endif
  #if N_AXIS > 4
    #define STEPPER_DISABLE_BIT_4 7 // Axis number 5 Step - Pin D30
  #endif
  #if N_AXIS > 5
    #define STEPPER_DISABLE_BIT_5 2 // Axis number 5 Step - Pin D24
  #endif
  ...
  #if N_AXIS > 3
    #define MIN_LIMIT_PORT_3 F // (Ramps Aux-1 D57)
  #endif
  #if N_AXIS > 4
  ...
  #if N_AXIS > 3
    #define MIN_LIMIT_BIT_3 3 // Axis number 6 : RAMPS AUX2 pin D57
  #endif
  #if N_AXIS > 4
    #define MIN_LIMIT_BIT_4 5 // Axis number 5 : RAMPS AUX2 pin D44
  #endif
  #if N_AXIS > 5
    #define MIN_LIMIT_BIT_5 7 // Axis number 4 : RAMPS AUX2 pin D42
  #endif
  ...
  #if N_AXIS > 3
    #define MAX_LIMIT_PORT_3 F // (Ramps Aux-3 D58)
  #endif
  #if N_AXIS > 4
    #define MAX_LIMIT_PORT_4 F
  #endif
  #if N_AXIS > 5
    #define MAX_LIMIT_PORT_5 G
  #endif
  ...
  #if N_AXIS > 3
    #define MAX_LIMIT_BIT_3 4 // Axis number 6 : RAMPS AUX1 pin D58
  #endif
  #if N_AXIS > 4
    #define MAX_LIMIT_BIT_4 5 // Axis number 5 : RAMPS AUX2 pin D59
  #endif
  #if N_AXIS > 5
    #define MAX_LIMIT_BIT_5 1 // Axis number 4 : RAMPS AUX2 pin D40
  #endif
